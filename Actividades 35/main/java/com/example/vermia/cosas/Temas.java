    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        temas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(), "Ya estás en Temas", Toast.LENGTH_SHORT).show();
        ...
        */
        ...
        public void temaRojo(View v){
            ...
            //Intent BusquedaInicio2= new Intent(getApplicationContext(),MainActivity.class);
            //startActivity(BusquedaInicio2);
