...
public class MainActivity extends AppCompatActivity
    ...
    private TextView ss;
    private ImageButton BusquedaImgInicio, pestanas1, pestanas2, pestanasPeliculas1, pestanasPeliculas2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pestanasPeliculas1 = (ImageButton) findViewById(R.id.pestanasPeliculas1);
        pestanasPeliculas2 = (ImageButton) findViewById(R.id.pestanasPeliculas2);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(), "Ya estás en Inicio", Toast.LENGTH_SHORT).show();
...
*/
    ...
    public void despliegaPeliculas(View v){
        ...
        if(listaPeliculas.getVisibility()==GONE){
            ...
            pestanasPeliculas1.setVisibility(INVISIBLE);
            pestanasPeliculas2.setVisibility(View.VISIBLE);
        }
        else {
            listaPeliculas.setVisibility(GONE);
            pestanasPeliculas1.setVisibility(View.VISIBLE);
            pestanasPeliculas2.setVisibility(INVISIBLE);
        }
    }
    ...
    public void tellamogilipollasenlacara(View v){
        Toast.makeText(getApplicationContext(), "Serie no disponible", Toast.LENGTH_SHORT).show();
    }

    public void tellamogilipollasenlacara2(View v){
        Toast.makeText(getApplicationContext(), "Película no disponible", Toast.LENGTH_SHORT).show();
    }
    ...
    public static void setCont(int i){ cont = i;}
