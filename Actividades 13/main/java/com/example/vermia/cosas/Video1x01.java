...
public class Video1x01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonFav1.setImageResource(R.mipmap.imagen_pausa);
        botonFav2.setImageResource(R.mipmap.imagen_pausa);
    ...
    public void pulsaFav1(View v){
        ...
        if(favs[1]){
            favs[1]=false;
            boton.setImageResource(R.mipmap.imagen_pausa);
        } else{
            favs[1]=true;
            boton.setImageResource(R.mipmap.imagen_play);
        }
    }
